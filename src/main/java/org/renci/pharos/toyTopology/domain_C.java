...
public class domain_C {
	public static void main(String[] args) {
		...
		Edge e1=graph.addEdge(null, v_C_a_1_in, v_C_a_2_out, org.renci.pharos.gui.LinePropertyConstants.Label.can);
		e1.setProperty("Capabilities",org.renci.pharos.gui.LinePropertyConstants.Capabilities.L2);
		e1=graph.addEdge(null, v_C_a_2_in, v_C_a_1_out, org.renci.pharos.gui.LinePropertyConstants.Label.can);
		e1.setProperty("Capabilities",org.renci.pharos.gui.LinePropertyConstants.Capabilities.L2);
		
		graph.addEdge(null, v_C_a_2_out, v_C_b_1_in, org.renci.pharos.gui.LinePropertyConstants.Label.is);
		graph.addEdge(null, v_C_b_1_out, v_C_a_2_in, org.renci.pharos.gui.LinePropertyConstants.Label.is);
		
		e1=graph.addEdge(null, v_C_b_1_in, v_C_b_2_out, org.renci.pharos.gui.LinePropertyConstants.Label.can);
		e1.setProperty("Capabilities",org.renci.pharos.gui.LinePropertyConstants.Capabilities.L2);
		e1=graph.addEdge(null, v_C_b_2_in, v_C_b_1_out, org.renci.pharos.gui.LinePropertyConstants.Label.can);
		e1.setProperty("Capabilities",org.renci.pharos.gui.LinePropertyConstants.Capabilities.L2);
		
		graph.addEdge(null, v_C_b_2_out, v_C_c_1_in, org.renci.pharos.gui.LinePropertyConstants.Label.is);
		graph.addEdge(null, v_C_c_1_out, v_C_b_2_in, org.renci.pharos.gui.LinePropertyConstants.Label.is);
		
		e1=graph.addEdge(null, v_C_c_1_in, v_C_c_2_out, org.renci.pharos.gui.LinePropertyConstants.Label.can);
		...
		e1=graph.addEdge(null, v_C_c_2_in, v_C_c_1_out, org.renci.pharos.gui.LinePropertyConstants.Label.can);
		e1.setProperty("Capabilities",org.renci.pharos.gui.LinePropertyConstants.Capabilities.L2+":"+org.renci.pharos.gui.LinePropertyConstants.Capabilities.Vlan);
