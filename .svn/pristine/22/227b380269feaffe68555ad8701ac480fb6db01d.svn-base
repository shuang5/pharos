...
public class NodeEdgePanel extends JPanel{
	...
	private String[] labels={
    		LinePropertyConstants.Types.L1,LinePropertyConstants.Types.L2, 
    		LinePropertyConstants.Types.L3,LinePropertyConstants.Types.Unkonwn
        };
	...
	public NodeEdgePanel(TopologyGraph t) {
        ...
        String node1id=((NodeCircle)(edge.getNode1())).getId();
        ...
        NodeCircle n=(NodeCircle)edge.getNode1();
        if (n!=null){
        ...
        String node2id=((NodeCircle)(edge.getNode2())).getId();
	...
	public void setEdge(){
    	...
    	n.setId(this.getId());
    	NodeCircle n1=(NodeCircle)edge.getNode1();
        NodeCircle n2=(NodeCircle)edge.getNode2();
        if (n1!=null && n2!=null){
			...
			try {
				FlowLabels l1=new FlowLabels(new FlowSpace(p1.getFlowSpace()));
				FlowLabels l2=new FlowLabels(new FlowSpace(p2.getFlowSpace()));
