...
//domain B has a diamond topology, i.e., 4 nodes a, b, c and d. a is connected to b and c, b and c are connected to d. a is peered
//with doman A and d is peered with domain C. 
public class domain_B {
	public static void main(String[] args) {
		String dbfilename = "./data/doe_pharos_domain_B.dex";
		...
		*/
		...
		try {
			writer.outputGraph("./data/doe_pharos_domain_B.xml");
		} catch (IOException e) {
			e.printStackTrace();
